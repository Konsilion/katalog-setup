...
function ModifPage(user,repo,page,token) {
    ...
    var style = document.createElement('style');
        style.type = 'text/css';
        style.innerHTML = '.md-content {margin: 50px auto; max-width: 100% !important; padding: 0 25px;} .md-content {margin: 50px auto; max-width: 100vw !important; padding: 0 25px;}';
